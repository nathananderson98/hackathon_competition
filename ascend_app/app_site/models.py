...
class AuthUser(AbstractUser):
    ...
    # MARK: Recruiter Specific Fields
    associated_company = models.ForeignKey('Company', on_delete=models.CASCADE, blank=True, default=None)
...
class RecruiterForm(ModelForm):
    class Meta:
        ...
        fields = ['username', 'password', 'first_name', 'last_name',
                  'email', 'phone_number', 'gender', 'associated_company']
